...
(1..407).each do |page_id|
  http = Curl.get("https://api.500px.com/v1/photos?rpp=38&feature=popular&image_size%5B%5D=3&image_size%5B%5D=2048&page=#{page_id}&sort=&include_states=true&formats=jpeg%2Clytro&only=&authenticity_token=Vi17RNpoPqhVOuvbEL1iAFi05AcsvEF2HQKWLfEVsiY%3D") do |http|
